# Contributing to Syncropel

Thanks for being interested in helping. Syncropel is an open protocol
for human + AI teams to coordinate, decide, and govern together. For
what Syncropel is and how it works, start with the [README](README.md)
and the [documentation site](https://docs.syncropel.com).
...
When in doubt between an issue and a discussion, start in
Discussions; we'll move it to an issue if it becomes actionable.
...
- **No silent rejections.** If we won't take a PR or feature
  request, we'll say so and explain why.

---

## Security

If you've found a security issue, please **don't** open a public
...
licensed under the same terms as the repository you're contributing
to. There is no Contributor License Agreement to sign.

---

## Code of conduct

All participants in the Syncropel community are expected to follow
the [Code of Conduct](CODE_OF_CONDUCT.md), which is the
[Contributor Covenant](https://www.contributor-covenant.org/) adopted
verbatim. Report concerns via the process described in that document.
